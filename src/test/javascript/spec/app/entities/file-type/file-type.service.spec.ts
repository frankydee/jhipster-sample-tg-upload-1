    ...
    describe('FileType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/file-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FileType', () => {
                service.create(new FileType(null)).subscribe(received => {
            ...
            it('should update a FileType', () => {
                service.update(new FileType(123)).subscribe(received => {
